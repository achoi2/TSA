...
class AnalysisGraph extends Component {
    ...
    render() {
        if (this.state.tones === null) {
            return <div className="analysis-graph">{"Tones do not exist. Write another Sentence"}</div>
        } else {
            return (
            <div className="analysis-graph">
                <VictoryChart height={340} width={600} domainPadding={20} theme={VictoryTheme.material}>
